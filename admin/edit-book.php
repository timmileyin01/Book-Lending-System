...
<main role="main" class="main-content col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div id="add-book" class="col-lg-6 mb-4 border">
        ...
        <form id="add-book-form" action="edit-book.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <button type="submit" class="btn btn-primary" name="update-book">Add Book</button>
        </form>
    </div>
