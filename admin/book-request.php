        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody id="requests-list">
                    <?php
                    $i = 0;
                    $borrows = selectAll('borrow', ['returned' => 0]);
                    foreach ($borrows as $key => $row) {
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td>
                                <?php if ($row['is_borrow'] == 1) {
                                    # code...
                                    ?>
                                    <a href="book-request.php?approve_book_id=<?= $row['borrow_id']; ?>"
                                        class="text-primary btn editBtn">Borrow</a>
                                <?php } elseif ($row['is_return'] == 1) { ?>
                                    <a href="book-request.php?approve_return_book_id=<?= $row['borrow_id']; ?>"
                                        class="text-success btn editBtn">Return</a>
                                <?php } else { ?>
